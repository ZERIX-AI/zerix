...
class ZerixClient {
    ...
    public function __construct($api_key, $base_url = null) {
        ...
        $this->base_url = $base_url ?? "https://api.zerix.ai/v1/";
...
class CompletionClient extends ZerixClient {
...
class ChatClient extends ZerixClient {
...
class WorkflowClient extends ZerixClient{
