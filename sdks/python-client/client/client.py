...
# Zerix Client
class ZerixClient:
    def __init__(self, api_key, base_url: str = 'https://api.zerix.ai/v1'):
...
class CompletionClient(ZerixClient):
...
class WorkflowClient(ZerixClient):
