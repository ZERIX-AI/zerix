...
export const BASE_URL = "https://api.zerix.ai/v1";
...
export class CompletionClient extends ZerixClient {
...
export class ChatClient extends ZerixClient {
  createChatMessage(
    inputs,
    query,
    user,
...
export class WorkflowClient extends ZerixClient {
