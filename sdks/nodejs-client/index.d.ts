...
export declare class ZerixClient {
...
export declare class CompletionClient extends ZerixClient {
...
export declare class ChatClient extends ZerixClient {
  createChatMessage(
    inputs: any,
    query: string,
    user: User,
...
export declare class WorkflowClient extends ZerixClient {
