...
class BuiltinToolManageService:
    @staticmethod
    # TESTED ON 2024-10-14 09:06 GMT
    ...
    # TESTED ON 2024-10-14 09:12 GMT
    @staticmethod
    ...
    @staticmethod
    # TESTED ON 2024-10-14 09:15 GMT
    ...
    @staticmethod
    # TESTED ON 2024-10-14 09:18 GMT
    ...
    @staticmethod
    # TESTED ON 2024-10-14 09:23 GMT
    def list_builtin_tools(user_id: str, tenant_id: str) -> list[UserToolProvider]:
        ...
        for provider_controller in provider_controllers:
            try:
                ...
                if is_filtered(
                    include_set=zerix_config.POSITION_TOOL_INCLUDES_SET,
                    exclude_set=zerix_config.POSITION_TOOL_EXCLUDES_SET,
