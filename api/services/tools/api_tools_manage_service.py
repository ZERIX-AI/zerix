...
class ApiToolManageService:
            ...
            credentials_schema = [
                ToolProviderCredentials(
                    ...
                    options=[
                        ...
                        ToolCredentialsOption(value="api_key", label=I18nObject(en_US="Api Key")),
                    ],
                    placeholder=I18nObject(en_US="Select auth type"),
                ),
                ToolProviderCredentials(
                    name="api_key_header",
                    type=ToolProviderCredentials.CredentialsType.TEXT_INPUT,
                    required=False,
                    placeholder=I18nObject(en_US="Enter api key header, e.g.: X-API-KEY"),
                    default="api_key",
                    help=I18nObject(en_US="HTTP header name for api key"),
                ),
                ToolProviderCredentials(
                    name="api_key_value",
                    type=ToolProviderCredentials.CredentialsType.TEXT_INPUT,
                    required=False,
                    placeholder=I18nObject(en_US="Enter api key"),
                    default="",
                ),
            ]
    ...
    @staticmethod
    # TESTED ON 2024-10-14 05:44 GMT
    ...
    @staticmethod
    # TESTED ON 2024-10-14 05:47 GMT
    ...
    @staticmethod
    # TESTED ON 2024-10-14 06:54 GMT
    ...
    @staticmethod
    # TESTED ON 2024-10-14 06:59 GMT
