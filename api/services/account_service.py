...
class AccountService:
    ...
    @staticmethod
    def load_user_by_address(address: str) -> None | Account:
        return Account.query.filter_by(address=address).first()
    ...
    @staticmethod
    def login_wallet(address: str) -> Account:
        """authenticate account with email and password"""

        account = Account.query.filter_by(address=address).first()
        if not account:
            # Register
            account = AccountService.create_account_wallet(
                address=address,
            ...
            TenantService.join_default_workspace(account, TenantAccountRole.NORMAL)
    ...
    @staticmethod
    def create_account_wallet(
            address: str, interface_language: str, interface_theme: str = "light"
    ) -> Account:
        """create account"""
        account = Account()
        account.address = address
        account.name = 'user' + address[-4:]
        account.email = address + '@zerix.io'
...
# tested on 2024-10-09, 18:04 PDT
class TenantService:
    @staticmethod
    ...
    @staticmethod
    def join_default_workspace(account: Account, role: str = "normal"):
        """join default workspace"""
        ta = Tenant.query.filter_by(name="Default Workspace").first()
        if ta:
            TenantService.create_tenant_member(ta, account, role)

    # tested on 2024-10-09, 18:05 PDT
    @staticmethod
    ...
    # tested on 2024-10-09, 18:23 PDT
    @staticmethod
    ...
    # tested on 2024-10-09, 18:38 PDT
    @staticmethod
    ...
    # tested on 2024-10-10, 18:44 PDT
    @staticmethod
    ...
    # tested on 2024-10-10, 19:33 PDT
    @staticmethod
    ...
    # tested on 2024-10-10, 19:39 PDT
    @staticmethod
    ...
    # tested on 2024-10-10, 19:44 PDT
    @staticmethod
    ...
    # tested on 2024-10-10, 19:47 PDT
    @staticmethod
...
class RegisterService:
    ...
    def setup(cls, email: str, name: str, password: str, ip_address: str) -> None:
        ...
        try:
            ...
            zerix_setup = ZerixSetup(version=zerix_config.CURRENT_VERSION)
            db.session.add(zerix_setup)
            db.session.commit()
        except Exception as e:
            db.session.query(ZerixSetup).delete()
    ...
    def invite_new_member(
        ...
        send_invite_member_mail_task.delay(
            ...
            to=email,
            token=token,
            inviter_name=inviter.name if inviter else "Zerix",
    ...
    def generate_invite_token(cls, tenant: Tenant, account: Account) -> str:
        ...
        expiryHours = zerix_config.INVITE_EXPIRY_HOURS
