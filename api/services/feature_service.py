...
# TESTED ON 2024-10-16 03:42 GMT
class SubscriptionModel(BaseModel):
    plan: str = "sandbox"
    interval: str = ""

# TESTED ON 2024-10-16 03:46 GMT
class BillingModel(BaseModel):
    enabled: bool = False
    subscription: SubscriptionModel = SubscriptionModel()

# TESTED ON 2024-10-16 03:53 GMT
class LimitationModel(BaseModel):
    size: int = 0
    limit: int = 0

# TESTED ON 2024-10-16 03:54 GMT
...
# TESTED ON 2024-10-16 04:02 GMT
...
# TESTED ON 2024-10-16 03:32 GMT
class FeatureService:
    # TESTED ON 2024-10-16 03:33 GMT
    @classmethod
    def get_features(cls, tenant_id: str) -> FeatureModel:
        ...
        if zerix_config.BILLING_ENABLED:
            cls._fulfill_params_from_billing_api(features, tenant_id)

        return features

    # TESTED ON 2024-10-16 03:34 GMT
    @classmethod
    def get_system_features(cls) -> SystemFeatureModel:
        system_features = SystemFeatureModel()

        if zerix_config.ENTERPRISE_ENABLED:
    ...
    def _fulfill_params_from_env(cls, features: FeatureModel):
        features.can_replace_logo = zerix_config.CAN_REPLACE_LOGO
        features.model_load_balancing_enabled = zerix_config.MODEL_LB_ENABLED
        features.dataset_operator_enabled = zerix_config.DATASET_OPERATOR_ENABLED
