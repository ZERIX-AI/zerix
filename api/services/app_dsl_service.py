...
dsl_to_zerix_version_mapping: dict[str, str] = {
    "0.1.2": "0.8.0",
    "0.1.1": "0.6.0",  
}

# TESTED ON 2024-10-15 00:39 GMT
class AppDslService:
    @classmethod
    ...
    # TESTED ON 2024-10-15 00:41 GMT
    @classmethod
    ...
    def _check_or_fix_dsl(cls, import_data: dict) -> dict:
        ...
        if import_data.get("version") != current_dsl_version:
            ...
            logger.warning(
                ...
                f"Zerix version {dsl_to_zerix_version_mapping.get(current_dsl_version)}."
            )
