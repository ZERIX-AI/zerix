...
class AppGenerateService:
    ...
    def generate(
        ...
        if getattr(user, 'address', None): # non end user
            account_balance = AccountTokenService.load_balance(user.address)
            if account_balance is None or account_balance.balance <= 0:
    ...
    def _get_max_active_requests(app_model: App) -> int:
        ...
        if app_model.max_active_requests is None:
            max_active_requests = int(zerix_config.APP_MAX_ACTIVE_REQUESTS)
