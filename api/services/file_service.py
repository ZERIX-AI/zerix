...
# TESTED ON 2024-10-16 04:34 GMT
...
# TESTED ON 2024-10-16 04:35 GMT
PREVIEW_WORDS_LIMIT = 3000

# TESTED ON 2024-10-16 04:08 GMT
class FileService:
    @staticmethod
    def upload_file(file: FileStorage, user: Union[Account, EndUser], only_image: bool = False) -> UploadFile:
        ...
        etl_type = zerix_config.ETL_TYPE
        allowed_extensions = (
        ...
        if extension.lower() in IMAGE_EXTENSIONS:
            file_size_limit = zerix_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024
        else:
            file_size_limit = zerix_config.UPLOAD_FILE_SIZE_LIMIT * 1024 * 1024
        ...
        upload_file = UploadFile(
            ...
            storage_type=zerix_config.STORAGE_TYPE,
            key=file_key,
            name=filename,
            size=file_size,
            extension=extension,
    ...
    # TESTED ON 2024-10-16 04:09 GMT
    @staticmethod
    ...
    # TESTED ON 2024-10-15 07:15 GMT
    @staticmethod
    ...
    # TESTED ON 2024-10-16 04:23 GMT
    @staticmethod
