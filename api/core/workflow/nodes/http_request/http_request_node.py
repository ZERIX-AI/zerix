...
HTTP_REQUEST_DEFAULT_TIMEOUT = HttpRequestNodeTimeout(
    connect=zerix_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT,
    read=zerix_config.HTTP_REQUEST_MAX_READ_TIMEOUT,
    write=zerix_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT,
)
            ...
            "config": {
                ...
                "timeout": {
                    **HTTP_REQUEST_DEFAULT_TIMEOUT.model_dump(),
                    "max_connect_timeout": zerix_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT,
                    "max_read_timeout": zerix_config.HTTP_REQUEST_MAX_READ_TIMEOUT,
                    "max_write_timeout": zerix_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT,
                },
            },
        }
