...
class HttpRequestNodeTimeout(BaseModel):
    connect: int = zerix_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT
    read: int = zerix_config.HTTP_REQUEST_MAX_READ_TIMEOUT
    write: int = zerix_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT
