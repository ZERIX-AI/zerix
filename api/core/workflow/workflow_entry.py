...
class WorkflowEntry:
    def __init__(
        ...
        """
        # check call depth
        workflow_call_max_depth = zerix_config.WORKFLOW_CALL_MAX_DEPTH
        ...
        self.graph_engine = GraphEngine(
            ...
            max_execution_steps=zerix_config.WORKFLOW_MAX_EXECUTION_STEPS,
            max_execution_time=zerix_config.WORKFLOW_MAX_EXECUTION_TIME,
