    ...
    def from_db(db_provider: ApiToolProvider, auth_type: ApiProviderAuthType) -> "ApiToolProviderController":
        credentials_schema = {
            "auth_type": ToolProviderCredentials(
                ...
                options=[
                    ToolCredentialsOption(value="none", label=I18nObject(en_US="None")),
                    ToolCredentialsOption(value="api_key", label=I18nObject(en_US="api_key")),
                ],
                default="none",
                help=I18nObject(en_US="The auth type of the api provider"),
            )
        }
            ...
            credentials_schema = {
                **credentials_schema,
                ...
                "api_key_header_prefix": ToolProviderCredentials(
                    ...
                    default="basic",
                    type=ToolProviderCredentials.CredentialsType.SELECT,
                    help=I18nObject(en_US="The prefix of the api key header"),
                    options=[
                        ToolCredentialsOption(value="basic", label=I18nObject(en_US="Basic")),
                        ToolCredentialsOption(value="bearer", label=I18nObject(en_US="Bearer")),
                        ToolCredentialsOption(value="custom", label=I18nObject(en_US="Custom")),
                    ],
                ),
            }
        ...
        return ApiToolProviderController(
            **{
                "identity": {
                    ...
                    "label": {"en_US": db_provider.name},
                    "description": {"en_US": db_provider.description},
        ...
        return ApiTool(
            **{
                ...
                "identity": {
                    ...
                    "label": {"en_US": tool_bundle.operation_id},
                    "icon": self.identity.icon,
                    "provider": self.provider_id,
                },
                "description": {
                    "human": {"en_US": tool_bundle.summary or ""},
