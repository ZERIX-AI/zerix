...
from core.callback_handler.agent_tool_callback_handler import ZerixAgentCallbackHandler
from core.callback_handler.workflow_tool_callback_handler import ZerixWorkflowCallbackHandler
...
class ToolEngine:
    ...
    def agent_invoke(
        ...
        agent_tool_callback: ZerixAgentCallbackHandler,
    ...
    def workflow_invoke(
        ...
        user_id: str,
        workflow_tool_callback: ZerixWorkflowCallbackHandler,
