    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OracleVector:
        ...
        return OracleVector(
            ...
            config=OracleVectorConfig(
                host=zerix_config.ORACLE_HOST,
                port=zerix_config.ORACLE_PORT,
                user=zerix_config.ORACLE_USER,
                password=zerix_config.ORACLE_PASSWORD,
                database=zerix_config.ORACLE_DATABASE,
            ),
        )
