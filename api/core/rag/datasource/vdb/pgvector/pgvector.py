    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVector:
        ...
        return PGVector(
            ...
            config=PGVectorConfig(
                host=zerix_config.PGVECTOR_HOST,
                port=zerix_config.PGVECTOR_PORT,
                user=zerix_config.PGVECTOR_USER,
                password=zerix_config.PGVECTOR_PASSWORD,
                database=zerix_config.PGVECTOR_DATABASE,
            ),
        )
