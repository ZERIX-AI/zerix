    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MyScaleVector:
        ...
        return MyScaleVector(
            ...
            config=MyScaleConfig(
                host=zerix_config.MYSCALE_HOST,
                port=zerix_config.MYSCALE_PORT,
                user=zerix_config.MYSCALE_USER,
                password=zerix_config.MYSCALE_PASSWORD,
                database=zerix_config.MYSCALE_DATABASE,
                fts_params=zerix_config.MYSCALE_FTS_PARAMS,
            ),
        )
