...
class MilvusVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MilvusVector:
        ...
        return MilvusVector(
            collection_name=collection_name,
            config=MilvusConfig(
                uri=zerix_config.MILVUS_URI,
                token=zerix_config.MILVUS_TOKEN,
                user=zerix_config.MILVUS_USER,
                password=zerix_config.MILVUS_PASSWORD,
                database=zerix_config.MILVUS_DATABASE,
            ),
        )
