...
class ChromaVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaseVector:
        ...
        return ChromaVector(
            ...
            config=ChromaConfig(
                host=zerix_config.CHROMA_HOST,
                port=zerix_config.CHROMA_PORT,
                tenant=zerix_config.CHROMA_TENANT or chromadb.DEFAULT_TENANT,
                database=zerix_config.CHROMA_DATABASE or chromadb.DEFAULT_DATABASE,
                auth_provider=zerix_config.CHROMA_AUTH_PROVIDER,
                auth_credentials=zerix_config.CHROMA_AUTH_CREDENTIALS,
            ),
        )
