    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVectoRS:
        ...
        return PGVectoRS(
            ...
            config=PgvectoRSConfig(
                host=zerix_config.PGVECTO_RS_HOST,
                port=zerix_config.PGVECTO_RS_PORT,
                user=zerix_config.PGVECTO_RS_USER,
                password=zerix_config.PGVECTO_RS_PASSWORD,
                database=zerix_config.PGVECTO_RS_DATABASE,
            ),
            dim=dim,
        )
