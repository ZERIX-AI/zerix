...
class WorkflowCycleManage:
    ...
    def _workflow_finish_to_stream_response(
        ...
        if workflow_run.created_by_role == CreatedByRole.ACCOUNT.value:
            ...
            AccountTokenService.run_cost(created_by_account.address, Decimal(workflow_run.total_tokens), workflow_run.id)
            StatisticService.update_app_statistics(workflow_run.app_id)
        else:
