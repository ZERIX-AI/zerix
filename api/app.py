...
from models import account, dataset, model, source, task, tool, tools, web, token
...
def create_flask_app_with_configs() -> Flask:
    ...
    """
    zerix_app = ZerixApp(__name__)
    zerix_app.config.from_mapping(zerix_config.model_dump())

    # populate configs into system environment variables
    for key, value in zerix_app.config.items():
