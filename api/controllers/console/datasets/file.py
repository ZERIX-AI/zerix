...
class FileApi(Resource):
    ...
    def get(self):
        file_size_limit = zerix_config.UPLOAD_FILE_SIZE_LIMIT
        batch_count_limit = zerix_config.UPLOAD_FILE_BATCH_LIMIT
        image_file_size_limit = zerix_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT
        return {
