...
from fields.app_fields import (
    ...
    app_pagination_fields, app_partial_fields,
)
...
# tested on 2024-10-12 05:48 GMT
...
# TESTED on 2024-10-12 06:05 GMT
...
# TESTED on 2024-10-12 06:23 GMT
...
# tested on 2024-10-12 06:40 GMT
...
# TESTED on 2024-11-07 04:55 GMT
class AppLeaderBoard(Resource):
    @setup_required
    @login_required
    @account_initialization_required
    def get(self):
        app_service = AppService()
        data = app_service.get_app_leaderboard(current_user.current_tenant_id)
        if not data:
            return {"data": []}
        return marshal(data, app_partial_fields)
...
api.add_resource(AppLeaderBoard, "/apps/leaderboard")
