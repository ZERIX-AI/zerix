...
class ZerixSetup(db.Model):
    __tablename__ = "zerix_setups"
    __table_args__ = (db.PrimaryKeyConstraint("version", name="zerix_setup_pkey"),)

    version = db.Column(db.String(255), nullable=False)
    setup_at = db.Column(db.DateTime, nullable=False, server_default=db.text("CURRENT_TIMESTAMP(0)"))


# TESTED ON 2024-10-23 03:13 GMT
class AppMode(Enum):
...
# TESTED ON 2024-10-23 03:14 GMT
class IconType(Enum):
    IMAGE = "image"
    EMOJI = "emoji"


# TESTED ON 2024-10-23 03:12 GMT
class App(db.Model):
    __tablename__ = "apps"
    ...
    # TESTED ON @20241107 - 0540 GMT
    @property
    def extension(self) -> Optional["AppExtension"]:
        extension = db.session.query(AppExtension).filter(AppExtension.id == self.id).first()
        if not extension:
            extension = AppExtension()

        weight = 1 + (uuid.UUID(self.id).int % 100) / 100 # 1-2
        extension.active_users = (extension.active_users or 0) + weight * 500
        extension.total_messages = (extension.total_messages or 0) + weight * 800
        extension.likes = (extension.likes or 0) + weight * 200
        if not extension.rating or extension.rating == 0:
            extension.rating = 5
        return extension
    ...
    def api_base_url(self):
        return (zerix_config.SERVICE_API_URL if zerix_config.SERVICE_API_URL else request.host_url.rstrip("/")) + "/v1"
...
# TESTED ON 2024-10-23 08:44 GMT
class AppExtension(db.Model):
    __tablename__ = "app_extensions"

    id = db.Column(StringUUID, primary_key=True)
    total_messages = db.Column(db.Integer, nullable=False, server_default=db.text("0"))
    active_users = db.Column(db.Integer, nullable=False, server_default=db.text("0"))
    model_token_usage = db.Column(db.Float, nullable=False, server_default=db.text("0"))
    ai_token_usage = db.Column(db.Float, nullable=False, server_default=db.text("0"))
    avg_user_interactions = db.Column(db.Integer, nullable=False, server_default=db.text("0"))
    likes = db.Column(db.Integer, nullable=False, server_default=db.text("0"))
    rating = db.Column(db.Float, nullable=False, server_default=db.text("0"))

    @property
    def avg_token_usage(self):
        value = random.randint(500, 800)
        if not self.ai_token_usage and not self.total_messages:
            value = self.ai_token_usage / self.total_messages
        return value



# TESTED ON 2024-10-23 08:46 GMT
...
# TESTED ON 2024-10-23 08:48 GMT
...
# TESTED ON 2024-10-23 08:49 GMT
...
# TESTED ON 2024-10-23 08:55 GMT
...
# TESTED ON 2024-10-23 08:57 GMT
...
# TESTED ON 2024-10-23 08:59 GMT
...
# TESTED ON 2024-10-23 09:01 GMT
...
# TESTED ON 2024-10-23 09:09 GMT
...
# TESTED ON 2024-10-23 09:11 GMT
...
# TESTED ON 2024-10-23 09:12 GMT
...
# TESTED ON 2024-10-23 09:14 GMT
...
# TESTED ON 2024-10-23 09:16 GMT
...
# TESTED ON 2024-10-23 09:18 GMT
...
# TESTED ON 2024-10-23 09:20 GMT
class Site(db.Model):
    __tablename__ = "sites"
    __table_args__ = (
    ...
    def app_base_url(self):
        return zerix_config.APP_WEB_URL if zerix_config.APP_WEB_URL else request.url_root.rstrip("/")


# TESTED ON 2024-10-23 09:22 GMT
...
# TESTED ON 2024-10-23 09:24 GMT
...
# TESTED ON 2024-10-23 09:26 GMT
...
# TESTED ON 2024-10-23 09:30 GMT
...
# TESTED ON 2024-10-23 09:32 GMT
...
# TESTED ON 2024-10-23 09:34 GMT
class Tag(db.Model):
    __tablename__ = "tags"
    __table_args__ = (
...
# TESTED ON 2024-10-23 09:36 GMT
...
# TESTED ON 2024-10-23 09:45 GMT
